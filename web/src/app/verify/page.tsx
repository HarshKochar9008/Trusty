...
import { Container, Typography, Button, Box, Alert, Grid, List, ListItem, ListItemIcon, ListItemText, Divider, Chip, Paper, Stepper, Step, StepLabel, StepContent } from '@mui/material';
...
export default function VerifyPage() {
  ...
  //           }}
  //         >
  //           Secure, AI-powered verification of health records with blockchain wallet integration
  //         </Typography>
  //       </Box>
